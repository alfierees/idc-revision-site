...
questions:
  ...
  - id: o1a
    ...
    solution: |
      ...
      $$\begin{gathered}
      p_1 = p_2 = MC = 20, \\
      T_1 = \tfrac12(200-20)^2 = 16{,}200, \\
      T_2 = \tfrac12(150-20)^2 = 8{,}450.
      \end{gathered}$$
  ...
  - id: o1d
    ...
    solution: |
      ...
      **Find the switch point** — set the two equal and solve the quadratic:
      $$\begin{aligned}
      \tfrac54 A^2 - 140A + 10{,}400 = 16{,}200 \\
      \Rightarrow \tfrac54 A^2 - 140A - 5{,}800 = 0 \\
      \Rightarrow A^2 - 112A - 4{,}640 = 0,
      \end{aligned}$$
      $$\begin{aligned}
      A &= \frac{112 \pm \sqrt{112^2 + 4(4640)}}{2} = \frac{112 \pm \sqrt{31{,}104}}{2} \\
      &= 56 \pm 36\sqrt6 \Rightarrow A^* = 56 + 36\sqrt{6} \approx 144.2.
      \end{aligned}$$
  ...
  - id: o2c
    ...
    solution: |
      ...
      **Best responses** (each firm differentiates w.r.t. its own variable, $MC=0$):
      $$\begin{aligned}
      \text{Firm 1: } \pi_1 = (12 - 0.75q_1 + 0.5p_2)q_1 \\
      \Rightarrow 12 - 1.5q_1 + 0.5p_2 = 0 \Rightarrow q_1 = 8 + \tfrac13 p_2,
      \end{aligned}$$
      $$\begin{aligned}
      \text{Firm 2: } \pi_2 = p_2(24 - p_2 - 0.5q_1) \\
      \Rightarrow 24 - 2p_2 - 0.5q_1 = 0 \Rightarrow p_2 = 12 - \tfrac14 q_1.
      \end{aligned}$$

      **Solve together** — substitute the second into the first:
      $$\begin{aligned}
      q_1 = 8 + \tfrac13\big(12 - \tfrac14 q_1\big) = 12 - \tfrac1{12}q_1 \\
      \Rightarrow \tfrac{13}{12}q_1 = 12 \Rightarrow q_1 = \tfrac{144}{13}, \\
