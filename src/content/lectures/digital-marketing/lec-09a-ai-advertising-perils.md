---
title: Promises and Perils of AI and Advertising
...
tags:
  ...
  - machine-learning
aliases:
  - "09a-Rodgers - Promises and Perils of AI and Advertising"
in_scope: true
---
...
> **Topic 9 — AI in Advertising** · Reading (editorial / themed-issue introduction)
> Citation: Rodgers, S. (2021). Themed issue introduction: Promises and perils of artificial intelligence and advertising. *Journal of Advertising, 50*(1), 1–10.
> Key concepts: [[AI Advertising]], [[Machine Learning]], [[Narrow AI]], [[Algorithmic Transparency]], [[AI Influencer]]
...
> [!note] Context statistics cited
> Over 75% of consumers already use an AI-powered service/device; ~53% growth expected in AI marketing in 2021; global digital advertising forecast at $517.51bn by 2023 with AI taking ~80%.

## Key Concepts & Definitions

> [!info] Definition — AI advertising (Rodgers' working definition)
> "Brand communication that uses a range of machine functions that learn to carry out tasks with intent to persuade with input by humans, machines, or both." Here *advertising* = brand communication with intent to persuade; *AI* = machine functions that learn with or without human help.

> [!info] Definition — AI influencer (Thomas & Fowler)
> "A digitally created artificial human who is associated with Internet fame and uses software and algorithms to perform tasks like humans."
