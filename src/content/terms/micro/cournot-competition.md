...
subject: micro
aliases: ["Cournot duopoly", "quantity competition"]
related: ["bertrand-competition", "stackelberg-model", "best-response-function", "cartel", "nash-equilibrium"]
source_folder: micro
ai_drafted: true
---

**Cournot competition** is the simultaneous quantity-setting model of oligopoly: firms choose $q_i$ independently, the market price clears at $P(q_1 + q_2)$, and the equilibrium is the [[Nash Equilibrium]] where each firm's reaction function (best response in quantities) crosses the other's. For the symmetric duopoly with $P = A - Q$ and $C_i = c q_i$:
